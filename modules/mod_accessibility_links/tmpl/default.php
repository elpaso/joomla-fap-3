            ...
            document.write('<div id="accessibility-links" class="accessibility-<?php echo $accessibility_class_suffix; ?>">');
                document.write('<form method="post" action="">');
                    document.write('<div class="has-icons">');
                        ...
                        document.write('<span class="accessibility-icon"><button type="submit" name="fap_skin" value="contrasthigh" id="contrasthigh" accesskey="X" onclick="fap_skin_change(\'swap\'); return false;" onkeypress="return handle_keypress(event, function(){skin_change(\'swap\');});" title="<?php echo JText::_('MOD_ACCESSIBILITY_HIGH_CONTRAST'); ?> [X]"><?php if($use_fa) echo '<em class="fa ' . $fa_class . ' fa-adjust"></em>' ?><span><?php echo JText::_('MOD_ACCESSIBILITY_HIGH_CONTRAST'); ?></span></button></span>');
                        <?php if('yes' == $params->get('liquid_variant')) { ?>
