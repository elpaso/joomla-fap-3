...
<div class="profile-edit<?php echo $this->pageclass_sfx?>">
	...
	<?php endif; ?>
		...
		<div class="control-group fap-submit">
			<div class="controls">
				<button type="submit" class="btn btn-primary validate"><span><span class="icon-save"></span> <?php echo JText::_('JSUBMIT'); ?></span></button>
				<a class="btn" href="<?php echo JRoute::_(''); ?>" title="<?php echo JText::_('JCANCEL'); ?>"><span class="icon-cancel"></span> <?php echo JText::_('JCANCEL'); ?></a>
